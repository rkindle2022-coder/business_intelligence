...
![Picture of the question "How many listings are in each of the 3 cities?" and the query result](business_intelligence/business/intelligence/apps/midwest_airbnb/images/Screenshot2026-09-25125428.png)
![Picture of the question "What is the average of all rated listings?" and the query result](apps/midwest_airbnb/images/Screenshot2026-09-25130120.png)
![Picture of the question "What is the average price of listings made in chicago?" and the query result](apps/midwest_airbnb/images/Screenshot2026-09-25130308.png)
